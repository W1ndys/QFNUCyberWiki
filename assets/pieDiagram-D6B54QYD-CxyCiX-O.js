import{c as V}from"./chunk-4KE642ED-BS-FKQop.js";import{p as G}from"./gitGraph-WSSBKK6M-L23UEOVH-ClDNiyA5.js";import{m as r,F as K,B as N,w as X,v as Y,c as j,b as q,t as y,H as I,l as J,a6 as U,aP as Z,aQ as M,aR as _,T as ee,h as te,aS as ae,p as ie}from"./mermaid.esm.min-lPGaG7vg.js";import"./chunk-5ZJXQJOJ-Dcje9Wu9.js";import"./app-Y8bH9Ejm.js";var re=ie.pie,T={sections:new Map,showData:!1},u=T.sections,D=T.showData,le=structuredClone(re),se=r(()=>structuredClone(le),"getConfig"),oe=r(()=>{u=new Map,D=T.showData,te()},"clear"),ne=r(({label:e,value:a})=>{u.has(e)||(u.set(e,a),y.debug(`added new section: ${e}, with value: ${a}`))},"addSection"),pe=r(()=>u,"getSections"),de=r(e=>{D=e},"setShowData"),ce=r(()=>D,"getShowData"),O={getConfig:se,clear:oe,setDiagramTitle:q,getDiagramTitle:j,setAccTitle:Y,getAccTitle:X,setAccDescription:N,getAccDescription:K,addSection:ne,getSections:pe,setShowData:de,getShowData:ce},fe=r((e,a)=>{V(e,a),a.setShowData(e.showData),e.sections.map(a.addSection)},"populateDb"),ge={parse:r(async e=>{let a=await G("pie",e);y.debug(a),fe(a,O)},"parse")},me=r(e=>`
  .pieCircle{
